  ...
  return (
    <div className="bg-[#171008]">
      <div className="flex justify-between items-center px-8 py-4">
        ...
        {/* Nav Links */}
        <div className="hidden md:flex gap-6 items-center text-[#865926]">
          <NavLink
            to={"/"}
      ...
      {/* Mobile menu -shows when menu open */}
      {menuOpen && (
        <div className="md:hidden flex flex-col px-8 pb-4 gap-4 text-[#865926] items-end">
          <NavLink
            to={"/"}
          ...
          {token && userData ? (
            <>
              ...
              <p onClick={logout} className="cursor-pointer text-white">
                Logout
              </p>
            </>
          ) : (
            <button
              ...
              className="text-white bg-[#865926] py-2 px-4 rounded-lg w-fit"
            >
              Login
            </button>
          )}
